...
_PIXABAY_EXTRACT_SYSTEM = (
    ...
    "[엄수 규칙]\n"
    "- 반드시 '눈에 보이는 구체적 사물/장면'으로. 추상적·은유적 단어(success, dream, future, journey 등) 절대 금지.\n"
    "- 그 업종 종사자가 실제로 쓰는 도구·작업 모습·현장을 떠올려라.\n"
    "- 설명/서론 없이 영문 단어(구) 3개만.\n"
    "[예시]\n"
    "- '부산개인회생' -> 'lawyer office, legal document, signing contract'\n"
    "- '역삼동 헬스장' -> 'gym interior, fitness equipment, workout'\n"
